...
{
    /**
     * @var string|null Contents of international shipment. Available Options are:
     * "merchandise", "documents", "gift", "returned_goods", or "sample"
     */
    public $contents;

    /**
     * @var array|null An array of customs items. Please note: If you wish to supply customsItems in the CreateOrder
    ...
    /**
     * @var string|null <td>Non-Delivery option for international shipment.  Available options are:
